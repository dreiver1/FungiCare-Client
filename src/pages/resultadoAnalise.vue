<template>
    <q-page class="column justify-between col-12" style="background-color: #087E05" id="page">
        ...
        <q-item class="col-4 bg-white column justify-center items-center self-end" style="border-radius: 30px 30px 0px 0px;">
